...
## Using Miniconda on c9.io

1. Spin up a machine
2. Open terminal
3. `mkdir downloads` – this is optional
4. `wget https://repo.continuum.io/miniconda/Miniconda3-latest-Linux-x86_64.sh` – downloading the miniconda installation file, you can also download for python 2.7 with the link from this page Do not download the 32-bit file!
5. `sudo bash Miniconda3-latest-Linux-x86_64.sh` – if you downloaded the python 3.5 installation.
6. Enjoy the power of Conda!